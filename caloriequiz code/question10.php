...
<center>
    ...
    <label2><progress id="pro" value="45" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">45</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/MatchaCake.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="question11.php" id="form" onsubmit="checkform()">
       <?php
  $q=$_POST['q'];

  print '<form method="post" action="question11.php">';
...
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q10"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q10').value.length==""){    
