...
<center>
    ...
    <label2><progress id="pro" value="40" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">40</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/TotallyTunaSandwich.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="question10.php" id="form" onsubmit="checkform()">
                          <?php
  $q=$_POST['q'];

  print '<form method="post" action="question10.php">';
...
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q9"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q9').value.length==""){    
        alert('Please input a number！');
        window.location.href="question9.php";
    }
}
