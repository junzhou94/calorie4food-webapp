...
<center>
    ...
    <label2><progress id="pro" value="95" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">95</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/SwissRoll.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="questionf.php" id="form" onsubmit="checkform()">
        <?php
  $q=$_POST['q'];

  print '<form method="post" action="questionf.php">';
...
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q20"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q20').value.length==""){    
        alert('Please input a number！');
        window.location.href="question20.php";
    }
}
