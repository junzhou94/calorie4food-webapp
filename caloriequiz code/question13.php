...
<center>
    ...
    <label2><progress id="pro" value="60" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">60</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/KiwiFruit.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="question14.php" id="form" onsubmit="checkform()">
                   <?php
  $q=$_POST['q'];

  print '<form method="post" action="question14.php">';
...
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q13"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q13').value.length==""){    
