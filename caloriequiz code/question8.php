...
<center>
    ...
    <label2><progress id="pro" value="35" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">35</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/ClassicGrilledHotDog.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="question9.php" id="form" onsubmit="checkform()">
                      <?php
  $q=$_POST['q'];

  print '<form method="post" action="question9.php">';
...
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q8"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q8').value.length==""){    
        alert('Please input a number！');
        window.location.href="question8.php";
    }
}
