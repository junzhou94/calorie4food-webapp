...
<center>
    ...
    <label2><progress id="pro" value="15" max="100"></progress></label2>&nbsp&nbsp&nbsp&nbsp<num id="num">15</num><num>%</num>
    <br><br>

    
<img id="pic" src="images/CheeseGouda.jpg" width="400px" height="300px" border="0" alt="">
<section>
<form method="post" action="question5.php" id="form" onsubmit="checkform()">
              <?php
  $q=$_POST['q'];

  print '<form method="post" action="question5.php">';
  print '<input name="q[]" type="hidden" value="'.$q[0].'">';
  print '<input name="q[]" type="hidden" value="'.$q[1].'">';
    print '<input name="q[]" type="hidden" value="'.$q[2].'">';
?>
    <input type="text" name="q[]" onkeyup="this.value=this.value.replace(/\D/g,'')" id="q4"> 
    <word>cal</word> 
...
function checkform(){ 
    if(document.getElementById('q4').value.length==""){    
